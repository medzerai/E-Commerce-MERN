...
import CategoryAllProductDisplay from "../components/CategoryAllProductDisplay";
  ...
  const handleZoomImage = useCallback(
    (e) => {
      ...
      setZoomImageCoordinate({
        x: Math.min(Math.max(x, 0), 1), // Ensure x is within [0, 1]
        y: Math.min(Math.max(y, 0), 1), // Ensure y is within [0, 1]
      });
    },
    [zoomImageCoordinate]
  );
    ...
    <div className="container mx-auto p-4">
      <div className="min-h-[200px] flex flex-col lg:flex-row gap-4">
        ...
        <div className="h-96 flex flex-col lg:flex-row-reverse gap-4">
          <div className="h-[300px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 relative p-4 shadow-md">
            <img
              src={activeImage}
            ...
            {/**product zoom */}
            {zoomImage && (
              <div className="hidden lg:block absolute min-w-[500px] overflow-hidden min-h-[400px] bg-slate-200 p-4 -right-[530px] top-0 shadow-lg">
                <div
                  ...
                  style={{
                    ...
                    backgroundSize: "150%", // Ensure the background is scaled up for zoom effect
                  }}
                ></div>
              </div>
            )}
